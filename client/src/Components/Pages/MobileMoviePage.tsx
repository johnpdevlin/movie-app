		...
		<>
			<Card sx={{ textAlign: 'center', contentAlign: 'center' }}>
				<CardContent>
					...
					{movie?.vote_average && <MovieRating value={movie?.vote_average!} />}
					{movie?.overview && (
...
export function MobileMovieSkeleton() {
	return (
		<Box>
			<Skeleton
				variant='rectangular'
				...
				width='90%'
			/>
			<Skeleton variant='text' animation='pulse' height='10%' width='90%' />
			<Skeleton variant='text' animation='pulse' height='10%' width='90%' />
			<Skeleton variant='text' animation='pulse' height='10%' width='90%' />
			<Skeleton variant='text' animation='pulse' height='10%' width='90%' />
		</Box>
